...
export default function FloatingWhatsApp() {
  ...
  /* Show the button after 1.5s so it doesn't clash with page load animations */
  useEffect(() => {
  ...
  return (
    <a
      ...
      aria-label="Chat with us on WhatsApp to place an order"
    ...
    >
      ...
      <span className="wa-fab__label">Order Now</span>
    </a>
  );
}
